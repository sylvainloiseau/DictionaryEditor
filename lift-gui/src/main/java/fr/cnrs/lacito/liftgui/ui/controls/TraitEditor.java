...
public final class TraitEditor extends VBox {
    ...
    private ComboBox<String> buildDefaultCombo(
        ...
        // if (
        //     t.getDefinition().getDataModel() == LiftFieldAndTraitDefinitionDataModel.OPTION
        //     || t.getDefinition().getDataModel() == LiftFieldAndTraitDefinitionDataModel.OPTION_COLLECTION
        //     || t.getDefinition().getDataModel() == LiftFieldAndTraitDefinitionDataModel.OPTION_SEQUENCE
        // ) {
